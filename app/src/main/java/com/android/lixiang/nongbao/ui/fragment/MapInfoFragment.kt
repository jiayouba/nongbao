...
class MapInfoFragment : SupportFragment(), AMap.OnMapClickListener,
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.activity_map_info, container, false)
    }
    ...
    private fun initViews(savedInstanceState: Bundle?) {
        ...
        mMapInfoToolbar.title = ""
        (activity as AppCompatActivity).setSupportActionBar(mMapInfoToolbar)

        mMapView!!.onCreate(savedInstanceState)
//        handlePermisson()
        init()
        initArea()
        mMapInfoLocateBtn.setOnClickListener(this)
        mMapInfoZoomInBtn.setOnClickListener(this)
        mMapInfoZoomOutBtn.setOnClickListener(this)
