...
//
    ...
    @POST("plotNumber/selectAddress")
    Call<AddressBeanNew> selectAddress();


    @POST("plotNumber/selectAddress")
    @FormUrlEncoded
    Call<AddressBeanNew> selectAddress1(
            @Field("city_name") String targetSentence1);

    @POST("plotNumber/selectAddress")
    @FormUrlEncoded
    Call<AddressBeanNew> selectAddress2(
            @Field("city_name") String targetSentence1,
            @Field("county_name") String targetSentence2);

    @POST("plotNumber/selectAddress")
    @FormUrlEncoded
    Call<AddressBeanNew> selectAddress3(
            @Field("city_name") String targetSentence1,
            @Field("county_name") String targetSentence2,
            @Field("town_name") String targetSentence3);
}
